...
if mode == "toggleAllNormal":
    sourcelist = ['5movies', '123123movies', 'anime1', 'animeram', 'animetoon', 'cartoonhd', 'cmovieshd',
                  'extramovies', 'filmxy', 'fmoviesio', 'ganool123', 'hdbest', 'hdmo', 'icefilms','iwannawatch',
                  'newepisodes', 'projectfreetv', 'series9', 'seriesonline', 'seriz', 'showbox', 'streamdreams',
                  'swatchseries', 'telepisodes', 'toonova', 'timewatch', 'watchepisodes4', 'watchfree', 'watchseries',
