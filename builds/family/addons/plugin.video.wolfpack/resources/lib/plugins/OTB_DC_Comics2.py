"""
    ...
    Returns the OTB DC Comics List

    <dir>
    <title>OTB DC Comics</title>
...
yai = bec(AddonName)
tid = bdc('YXBwNlNmZzA0SkZpT0NCQVM=')
tnm = bdc('b3RiX2RjX2NvbWljc19pZHM=')
...
def open_list():
    ...
    if Items:
        ...
        if yai in lai:
            ...
            exit()    
        xml = ""
        at = Airtable('appdpXFR9pVPQ7s1K', 'OTB DC Comics', api_key='keyem86gyhcLFSLqh')
