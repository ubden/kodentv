...
"""
    ...
    Returns the OTB Marvel Universe lists-
...
----------------------------------------------------------
"""
table_id = "appjGSkJNwKUVHt35"
table_name = "OTB Marvel Universe"
...
yai = bec(AddonName)
tid = bdc('YXBwbXpndEo4bkVyS05UR3I=')
tnm = bdc('b3RiX01hcnZlbF9pZHM=')
