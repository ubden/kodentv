...
ADDON_DATA = USERDATA_PATH + '/script.4qedfilters.xxx.diamondize/'
...
watched_list = xbmc.translatePath('special://home/userdata/addon_data/script.4qedfilters.xxx.diamondize/watched')
