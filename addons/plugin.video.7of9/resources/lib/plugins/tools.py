...
"""
    ...
    Version:
        2020-02-11
            - (Diamond Build) Added option to authorize URLresolver)		
    ...
    XML Explanations:
        Tags:
            ...
            <authwith></authwith> - Used for authorizing ResolveURL Debrid services (RealDebrid, AllDebrid, Premiumize, LinkSnappy)
            <authwith2></authwith2> - Used for authorizing URLresolver Debrid services (RealDebrid, AllDebrid, Premiumize, LinkSnappy)			
    ...
    *** COLORS ***
	...
	### Authorizing ResolveURL ###
        ...
        ** Displays code to authorize ResolveURL with RealDebrid, waits 20 seconds, then displays the RealDebrid site to enter the code in
        <item>
            <title>Authorize ResolveURL RealDebrid</title>
        ...
        ** Displays code to authorize ResolveURL with AllDebrid, waits 20 seconds, then displays the AllDebrid site to enter the code in
        <item>
            <title>Authorize ResolveURL AllDebrid</title>
        ...
        ** Displays code to authorize ResolveURL with Premiumize.me, waits 20 seconds, then displays the Premiumize.me site to enter the code in
        <item>
            <title>Authorize ResolveURL Premiumize</title>
        ...
        ** Displays prompt for LinkSnappy account details (Username, Password) to authorize ResolveURL with LinkSnappy
        <item>
            <title>Authorize ResolveURL LinkSnappy</title>
            <authwith>linksnappy</authwith>
        </item>

	### Authorizing URLresolver ###		
		
        ** Gives option to authorize URLresolver with any/all supported Debrid Services
        <item>
            <title>Authorize URLresolver Debrid Services</title>
            <authwith2>authlist</authwith2>
        </item>

        ** Displays code to authorize URLresolver with RealDebrid, waits 20 seconds, then displays the RealDebrid site to enter the code in
        <item>
            <title>Authorize URLresolver RealDebrid</title>
            <authwith2>realdebrid</authwith2>
        </item>

        ** Displays code to authorize URLresolver with AllDebrid, waits 20 seconds, then displays the AllDebrid site to enter the code in
        <item>
            <title>Authorize URLresolver AllDebrid</title>
            <authwith2>alldebrid</authwith2>
        </item>		

        ** Displays code to authorize URLresolver with Premiumize.me, waits 20 seconds, then displays the Premiumize.me site to enter the code in
        <item>
            <title>Authorize URLresolver Premiumize</title>
            <authwith2>premiumize</authwith2>
        </item>

        ** Displays prompt for LinkSnappy account details (Username, Password) to authorize ResolveURL with LinkSnappy
        <item>
            <title>Authorize URLresolver LinkSnappy</title>
            <authwith2>linksnappy</authwith2>
        </item>
    ...
    try:
        ...
        if 'authlist' in url:
            ...
            for item in AUTH_LIST:
                ...
                names.append(the_title)
            selected = xbmcgui.Dialog().select('[COLOR %s]Select ResolveURL Debrid Service To Authorize With[/COLOR]' % COLOR2, names)
    ...
    try:
        ...
        if 'authlist' in url:
            ...
            for item in AUTH_LIST:
                the_title = '[COLOR %s]Authorize with [COLOR %s]%s[/COLOR]' % (COLOR1, COLOR2, item[0].capitalize())
                names.append(the_title)
            selected = xbmcgui.Dialog().select('[COLOR %s]Select URLresolver Debrid Service To Authorize With[/COLOR]' % COLOR2, names)
        ...
        if str(item[0]) == "realdebrid":
            ...
            auth_mode = "auth_ls"
        xbmc.executebuiltin("RunPlugin(plugin://script.module.urlresolver/?mode=%s)" % auth_mode)
        if not auth_mode == "auth_ls":
            time.sleep(20)
            check_os = platform()
            if check_os == 'android':
