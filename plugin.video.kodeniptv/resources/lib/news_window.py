...
def Dialog_Example():
    ...
    main_text = mytext
    my_buttons = ['Kapat']
    my_choice = koding.Custom_Dialog(main_content=main_text,pos='center',size='900x600',buttons=my_buttons,transparency=90,highlight_color='yellow',header='Yenilikler')
    if my_choice == 1: 
        return