...
def main():
    main_url = "https://raw.githubusercontent.com/ubden/kodentv/master/docs/repo/main.xml"  #your main.xml url goes here
    sections = [
        {'name': 'koden', # can change jen to whatever you want.  This wil name the output xml jen.xml
         'url': "https://raw.githubusercontent.com/ubden/kodentv/master/docs/repo/main.xml", # your section xml goes here
         'poster': 'kdoen'}, # can change Jen to whatever you want. This will be displayed as the poster name on jen.xml and
