...
my_settings = {'root_xml':'https://raw.githubusercontent.com/ubden/kodentv/master/docs/repo/main.xml'}
    ...
    try:
        ...
        try:
            ...
            if not message_xml_url == None:
                ...
                my_settings['message_xml_url'] = (message_xml_url if not 'visible' in message_xml_url else 'https://raw.githubusercontent.com/ubden/kodentv/master/docs/bildirim.txt')
            else:
                my_settings['message_xml_url'] = 'https://raw.githubusercontent.com/ubden/kodentv/master/docs/bildirim.txt'
        except:
            failure = traceback.format_exc()
